...
const Game = ({ playerChoice, opponentChoice, onMakeChoice, message, currentPlayer, opponent, gameState, roomId, onReturnToMenu }) => {
  const getRoundProgress = () => {
    ...
    return ((gameState.round - 1) / gameState.maxRounds) * 100;
  };
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-black p-3">
      {/* Top Bar: Room ID + Game Info */}
        ...
        <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
          ...
          {gameState && (
            <>
              ...
              <Progress value={getRoundProgress()} className="w-16" />
            </>
          )}
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <Card className="mb-3 bg-white/95 backdrop-blur-sm border-0 shadow-lg">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-3">
            ...
            <CardContent className="text-center p-4 flex flex-col justify-between h-full">
              {currentPlayer && (
                <div className="space-y-3">
                  <Avatar className="w-16 h-16 mx-auto border-3 border-blue-400">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm font-semibold text-gray-700">
                      {playerChoice ? playerChoice.charAt(0).toUpperCase() + playerChoice.slice(1) : 'Thinking...'}
                    </p>
                  </div>
                </div>
              )}
          ...
          <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-lg">
            ...
            <CardContent className="text-center p-4 flex flex-col justify-between h-full">
              {opponent ? (
                <div className="space-y-3">
                  <Avatar className="w-16 h-16 mx-auto border-3 border-red-400">
                  ...
                  <div className="mt-4 p-3 bg-red-50 rounded-lg">
                    ...
                    <p className="text-sm font-semibold text-gray-700">
                      {opponentChoice ? opponentChoice.charAt(0).toUpperCase() + opponentChoice.slice(1) : 'Thinking...'}
                    </p>
                  </div>
                </div>
              ) : (
